...
function multiplayer(player1Turn, player2Turn) {
    switch (true) {
        case player1Turn == player2Turn:
            ...
            break;
        case player1Turn == "Rock" && player2Turn == "Paper":
        case player1Turn == "Paper" && player2Turn == "Scissors":
        case player1Turn == "Scissors" && player2Turn == "Rock":
